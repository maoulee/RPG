...
打分口径 v2: per-gold 序列 log-likelihood(token SUM, log 域); 判定 D_max≤0.5 且 D_mean≤0.5 才移除
...
◆ RSCC: d(per-gold)=[-3.78 -3.02]  D_max=-3.018 D_mean=-3.397 cov=0 → 移除
◆ LOO:  d(per-gold)=[-0.87 -1.97]  D_max=-0.8699 D_mean=-1.418
...
◆ RSCC: d(per-gold)=[+8.79 +3.15]  D_max=8.791 D_mean=5.971 cov=1 → 保留
◆ LOO:  d(per-gold)=[+1.87 +1.17]  D_max=1.874 D_mean=1.52
  [结构: necessary=n/a pathway=eclipse tour]
...
〔通路 Eclipse Tour〕起始 l_alone(per-gold)=[-10.04 -13.11]
  块#2 结构=n/a(通路未达): d=[+8.79 +3.15] D_max=8.791 D_mean=5.971 cov=1 ⇒ Informative → 保留
  块#1 结构=n/a(通路未达): d=[-3.78 -3.02] D_max=-3.018 D_mean=-3.397 cov=0 ⇒ Redundant-valid → 移除

...
◆[5] 基线块: gold=无  通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=3.62e-06 p_removed=1.57e-05 档=effective]
...
layer_action: extend
◆[9] 层操作: 通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=1.34e-06 p_removed=7.43e-06 档=effective]
...
layer_action: extend
◆[13] 层操作: 通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=5.08e-06 p_removed=3.72e-06 档=effective]
...
layer_action: extend
◆[18] 层操作: 通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=8.78e-06 p_removed=4.49e-06 档=redundant_irr]
...
◆[5] 基线块: gold=无  通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=2.89e-06 p_removed=2.76e-06 档=effective]
...
◆[9] 基线块: gold=无  通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=1.47e-06 p_removed=2.36e-06 档=effective]
...
◆[13] 层操作: 通路=freemasonry/unreached  结构必要=n/a(gold未连通)  [p_alone=4.75e-06 p_removed=2.15e-06 档=effective]
...
◆[17] 层操作: 通路=freemasonry fran/unreached  结构必要=n/a(gold未连通)  [p_alone=1.06e-05 p_removed=1.73e-06 档=effective]
...
layer_action: extend
◆[21] 层操作: 通路=freemasonry/unreached  结构必要=n/a(gold未连通)  [p_alone=2.04e-06 p_removed=2.55e-06 档=redundant_dup]
...
layer_action: extend
◆[29] 层操作: 通路=franz liszt/unreached  结构必要=n/a(gold未连通)  [p_alone=3.03e-06 p_removed=1.74e-06 档=redundant_dup]
...
◆[5] 基线块: gold=无  通路=siege of vicksbu/substitute  结构必要=必要(删后断)  [p_alone=0.0672 p_removed=0.0308 档=effective]
...
★[10] 命中GOLD: John C. Pemberton
   > John C. Pemberton --person.place_of_birth--> Philadelphia
◆[10] 层操作: 通路=siege of vicksbu/substitute  结构必要=必要(删后断)  [p_alone=0.0291 p_removed=0.0470 档=effective]
...
◆[15] 层操作: 通路=siege of vicksbu/substitute  结构必要=非必要(删后通)  [p_alone=0.0314 p_removed=0.0405 档=redundant_irr]
...
★[5] 命中GOLD: The Journey
   > The Journey --film.directed_by--> Anatole Litvak
◆[5] 基线块: gold=有  通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=8.50e-04 p_removed=2.23e-04 档=effective]
...
layer_action: extend
◆[9] 层操作: 通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=1.64e-04 p_removed=6.36e-04 档=redundant_irr]
...
layer_action: repeat
◆[12] 层操作: 通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=2.17e-04 p_removed=4.84e-04 档=redundant_dup]
...
★[5] 命中GOLD: Village of the Giants
   > Bert I. Gordon --director.film--> Village of the Giants
   > Village of the Giants --film.directed_by--> Bert I. Gordon
◆[5] 基线块: gold=有  通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=0.0075 p_removed=0.6565 档=effective]
...
layer_action: extend
◆[9] 层操作: 通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=0.0070 p_removed=0.6454 档=effective]
...
note: ⚠ Passing only 'A Beautiful Mind' narrows the relation pool to just that entity's edges — ?movie has 37 candidates whose relations may differ. For full-frontier relation discovery, pass the variable ?movie or ALL relevant entities together. A single literal is fine when the tree continuation handles it (the system walks from the root regardless). SEQUENCE EXTENSION applied to several frontier members — the new layer's edges are per-candidate: COMPARE them across the candidates (values, dates, ids) and commit the discriminated one(s), never the whole frontier roster. Mid-chain entities are HOPS, not answers. triples are the evidence: 'h --rel--> t1 | t2 | ...' (one head, many tails) or 'h1 | h2 | ... --rel--> tail' (many heads, one tail), '|' separates entities. Entities shown as m.xxx / g.xxx are EVENT nodes — abstract compound entities whose ATTRIBUTES are the event's content. EXAMPLE: 'm.0abc --performance.character--> Denver | --performance.actor--> Jon Favreau' means 'a performance event where the character Denver was played by Jon Favreau'. Event nodes are NEVER answer candidates and NEVER variable bindings — answer and bind with the event's named ATTRIBUTES (actor, character, office holder, jurisdiction). Discriminator attributes (dates, incumbent) appear as their own edges — read them to pick latest/largest/incumbent. Each subgraph shows the FULL evidence its pattern paths justify — an edge may legitimately reappear across subgraphs with its complete tail set. Pick the next center FROM these triples.
layer_action: repeat
◆[11] 层操作: 通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=0.0059 p_removed=0.6142 档=effective]
...
◆[15] 层操作: 通路=ron howard/unreached  结构必要=n/a(gold未连通)  [p_alone=0.0071 p_removed=0.6769 档=effective]
...
★[19] 命中GOLD: Village of the Giants
   ...
   > Village of the Giants --film.subjects--> Child prodigy
   > ── Village of the Giants ──
◆[19] 基线块: gold=有  通路=child prodigy/substitute  结构必要=必要(删后断)  [p_alone=0.7438 p_removed=0.5199 档=effective]
...
★[24] 命中GOLD: Village of the Giants
   ...
   > Bert I. Gordon | m.02vbp6p | m.0k7rl9 --director.film--> Village of the Giants
   > Bert I. Gordon --film_story_contributor.film_story_credits--> Village of the Giants
◆[24] 层操作: 通路=child prodigy/substitute  结构必要=非必要(删后通)  [p_alone=0.6745 p_removed=0.7307 档=effective]
...
★[5] 命中GOLD: Poetic Justice
   ...
   > ── Poetic Justice ──
   > Janet Jackson | John Singleton | m.02tb74m | m.02vb3h0 | m.02vckpm | m.02vcy64 | m.02vd72n | m.03jpsrt | m.03l7r6x | m.05k9530 | m.0cgc3xp | m.0h3043j …(+3) --director.film--> Poetic Justice
◆[5] 基线块: gold=有  通路=tupac shakur/substitute  结构必要=必要(删后断)  [p_alone=0.4773 p_removed=0.3712 档=effective]
...
★[10] 命中GOLD: Poetic Justice
   ...
   > ── Poetic Justice ──
   > m.02vb3h0 --performance.film--> Poetic Justice
◆[10] 基线块: gold=有  通路=tupac shakur/substitute  结构必要=非必要(删后通)  [p_alone=0.3468 p_removed=0.5174 档=effective]
...
★[17] 命中GOLD: Poetic Justice
   ...
   > John Singleton --director.film--> Poetic Justice
   > Poetic Justice --film.directed_by--> John Singleton
◆[17] 层操作: 通路=tupac shakur/substitute  结构必要=非必要(删后通)  [p_alone=0.4397 p_removed=0.5291 档=effective]
...
note: evidence blocks group triples by entity. 'h --rel--> t1 | t2' merges tails; m.xxx [key: value] shows a CVT's attributes inline. Compare blocks by bracketed values to discriminate candidates.
note: triples are the evidence: 'h --rel--> t1 | t2 | ...' (one head, many tails) or 'h1 | h2 | ... --rel--> tail' (many heads, one tail), '|' separates entities. Entities shown as m.xxx / g.xxx are EVENT nodes — abstract compound entities whose ATTRIBUTES are the event's content. EXAMPLE: 'm.0abc --performance.character--> Denver | --performance.actor--> Jon Favreau' means 'a performance event where the character Denver was played by Jon Favreau'. Event nodes are NEVER answer candidates and NEVER variable bindings — answer and bind with the event's named ATTRIBUTES (actor, character, office holder, jurisdiction). Discriminator attributes (dates, incumbent) appear as their own edges — read them to pick latest/largest/incumbent. Each subgraph shows the FULL evidence its pattern paths justify — an edge may legitimately reappear across subgraphs with its complete tail set. Pick the next center FROM these triples.
◆[5] 基线块: gold=无  通路=ethiopian birr/substitute  结构必要=必要(删后断)  [p_alone=0.4056 p_removed=0.8492 档=effective]
...
★[9] 命中GOLD: Hailemariam Desalegn
   > ── Hailemariam Desalegn ──
   > m.0n1nqyj --government_position_held.office_holder--> Hailemariam Desalegn
◆[9] 层操作: 通路=ethiopian birr/substitute  结构必要=必要(删后断)  [p_alone=0.8492 p_removed=0.4428 档=effective]
...
==========================================================================================
CASE WebQTrn-2209_c1374f388d9cc7a78365860c91218362  sample s0  f1=0.11  hit=True  miss_kind=-  证据图gold连通=是  概率 p0=0.0418 pF=0.3129 Δ=+0.2711
...
◆[5] 基线块: gold=无  通路=brad stevens/substitute  结构必要=必要(删后断)  [p_alone=0.0543 p_removed=0.2932 档=effective]
...
◆[9] 层操作: 通路=brad stevens/substitute  结构必要=必要(删后断)  [p_alone=0.2944 p_removed=0.0546 档=effective]
...
==========================================================================================
CASE WebQTrn-1731_4eea981607dbe17b040580ce4cd93ec4  sample s0  f1=1.00  hit=True  miss_kind=-  证据图gold连通=是  概率 p0=0.0027 pF=0.1780 Δ=+0.1753
...
◆[5] 基线块: gold=无  通路=randy jackson/substitute  结构必要=非必要(删后通)  [p_alone=0.0013 p_removed=0.0778 档=effective]
...
★[9] 命中GOLD: Bass guitar, Vocals
   ...
   > --group_member.membership--> m.01tf0q1 [has_no_value: Period (end); member: Neal Schon; role: Vocals]
   > --group_member.membership--> m.01vxjq8 [end: 1987-08:00; member: Randy Jackson; role: Bass guitar | Vocals; start: 1985-08:00]
◆[9] 基线块: gold=有  通路=eclipse tour/substitute  结构必要=必要(删后断)  [p_alone=0.1477 p_removed=0.1245 档=effective]
...
★[13] 命中GOLD: Bass guitar, Vocals
   ...
   > m.01vxjq8 --group_membership.role--> Bass guitar
   > m.040rysf --group_membership.role--> Bass guitar
◆[13] 层操作: 通路=randy jackson/substitute  结构必要=必要(删后断)  [p_alone=0.1030 p_removed=0.2050 档=effective]
...
◆[17] 层操作: 通路=eclipse tour/substitute  结构必要=非必要(删后通)  [p_alone=0.0013 p_removed=0.1789 档=redundant_irr]
...
==========================================================================================
CASE WebQTrn-2784_b64250ae3c9d6c724133d09dad5593ec  sample s0  f1=1.00  hit=True  miss_kind=-  证据图gold连通=是  概率 p0=0.0359 pF=0.5137 Δ=+0.4779
Q: What movie featuring Tupac was directed by Kirk M. Petruccelli?
GOLD: ['Poetic Justice']
...
★[5] 命中GOLD: Poetic Justice
   ...
   > m.02vb3h0 --performance.film--> Poetic Justice
   > m.02vckpm --performance.film--> Poetic Justice
◆[5] 基线块: gold=有  通路=tupac shakur/substitute  结构必要=必要(删后断)  [p_alone=0.6786 p_removed=0.5573 档=effective]
...
★[14] 命中GOLD: Poetic Justice
   ...
   > Poetic Justice --film.film_art_direction_by--> Kirk M. Petruccelli
   > John Singleton --director.film--> Poetic Justice
◆[14] 层操作: 通路=kirk m petruccel/substitute  结构必要=必要(删后断)  [p_alone=0.5437 p_removed=0.6751 档=effective]
...
==========================================================================================
CASE WebQTest-626_01ad90831a03b6c5ef17898ccd80a639  sample s0  f1=1.00  hit=True  miss_kind=-  证据图gold连通=是  概率 p0=0.0227 pF=0.3998 Δ=+0.3771
...
◆[5] 基线块: gold=有  通路=tempus unbound/substitute  结构必要=必要(删后断)  [p_alone=0.6415 p_removed=0.3626 档=effective]
...
★[9] 命中GOLD: Kansas
   ...
   > Arkansas --location.containedby--> Contiguous United States | United States of America | United States, with Territories
   > Arkansas River --location.containedby--> North America | United States of America
◆[9] 层操作: 通路=tempus unbound/substitute  结构必要=必要(删后断)  [p_alone=0.4362 p_removed=0.4820 档=effective]
...
★[13] 命中GOLD: Kansas
   ...
   > Kansas --location.partially_contains--> Big Blue River
   > Kansas --location.partially_contains--> Little Osage River
◆[13] 基线块: gold=有  通路=missouri river/substitute  结构必要=必要(删后断)  [p_alone=0.3018 p_removed=0.6874 档=effective]
...
==========================================================================================
CASE WebQTrn-2576_872253e47dd6ddaa213ff31eeda8783b  sample s0  f1=0.00  hit=False  miss_kind=answer-stage  证据图gold连通=是  概率 p0=0.0001 pF=0.0069 Δ=+0.0068
...
★[5] 命中GOLD: Americas
   ...
   > ── Americas ──
   > Anguilla | Antigua and Barbuda | Aruba | Bahamas | Barbados | Belize | Bermuda | Bonaire | British Virgin Islands | Canada | Caribbean | Cayman Islands …(+6) --location.containedby--> Americas
◆[5] 基线块: gold=有  通路=falkland islands/substitute  结构必要=非必要(删后通)  [p_alone=0.0387 p_removed=0.0038 档=effective]
...
★[9] 命中GOLD: Americas
   > ── Americas ──
   > Anguilla | Falkland Islands | Montserrat | Turks and Caicos Islands --location.containedby--> Americas
◆[9] 基线块: gold=有  通路=falkland islands/substitute  结构必要=非必要(删后通)  [p_alone=0.0108 p_removed=0.0162 档=effective]
...
★[13] 命中GOLD: Americas
   > --location.containedby--> Americas | Atlantic Ocean
◆[13] 层操作: 通路=united kingdom/unreached  结构必要=n/a(gold未连通)  [p_alone=3.86e-06 p_removed=0.0106 档=redundant_irr]

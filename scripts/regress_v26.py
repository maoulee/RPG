...
Writes specs/regress_v26_2026-09-23.md
"""
import json, re
...
CASES = ["WebQTest-537_a52d362d", "WebQTrn-2784_3a127296", "WebQTrn-372_5ac0136",
         "WebQTest-1171_08b211ab", "WebQTrn-241_97bfe74d", "WebQTest-1923_2d07732",
         "WebQTest-537_4346bf5a"]
...
def main():
    ...
    for pfx in CASES:
        ...
        for ln in lost[:40]:
            L.append(f"    - {ln[:150]}")
    open("specs/regress_v26_2026-09-23.md", "w").write("\n".join(L) + "\n")
    print("wrote specs/regress_v26_2026-09-23.md")
